...
venuelabel = Label(window, text="Venue: ", background="#150051", fg="white", font=("kaiti", 13)).place(x=0, y=660)
contactLabel = Label(window, text="Contact: ", background="#150051", font=("kaiti", 13), foreground="White").place(x=0,
                                                                                                                  y=720)
...
help_menu.add_command(label="About Us", command=website)
help_menu.add_command(label="Tutorials", command=tutorial)
